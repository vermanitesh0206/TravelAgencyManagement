        ...
        <table id="pkg">
            ...
            <?php 
              ...
              $db = mysqli_connect('localhost', 'root', '', 'travelagency');
                  ...
                  $sql= "SELECT * FROM bookings,time WHERE bookings.bookid=time.bookid and phone= '$phone';";
            ...
            <form class="input" action="index2.php" method="post">
                <button type="submit" name="sub_pkg"><h3>Check/New Booking<h3></button>
            </form>
